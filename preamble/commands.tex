...
%-----------------------------------------------------------------------------%
\author{Lukas Wala}
\newcommand{\daAutor}{Lukas Wala}
\newcommand{\daMatrikelnummer}{807291}
\newcommand{\daTitel}{Nutzergesteuerte Datenwertschöpfung in heterogenen Cloud-Native Anwendungsumgebungen}
\newcommand{\daTitelEins}{Nutzergesteuerte Datenwertschöpfung}
\newcommand{\daTitelZwei}{in heterogenen}
\newcommand{\daTitelDrei}{Cloud-Native Anwendungsumgebungen}
\newcommand{\daUnternehmen}{Universitätsklinikum Erlangen}
...
\newcommand{\daAutorAdresse}{Zeppelinstraße 14}
\newcommand{\daAutorPLZ}{91052}
\newcommand{\daAutorOrt}{Erlangen}

\newcommand{\daDate}{31.12.2025}


\newcommand{\daGutachterEins}{MBA Karl-Heinz Leicht}
