...
\lstset{
    language=R,         % Sourcecode language ist C++
    numbers=left,            % No linenumbers
%    stepnumber=1,            % Every line got his own number.
    numbersep=5pt,           % 5pt distance to Sourcecode
    numberstyle=\tiny\color{codegray},       % tiny numbers.
    ...
    backgroundcolor=\color{backcolour}, % Hintergrundfarbe des Quellcodes setzen.
    ...
    captionpos=b,
    keepspaces=true,
    title={Datenauswertung von JetBrains Umfragen in R}
} 
%-----------------------------------------------------------------------------%
...
% }
% Stern (IEEE)
\usepackage[style=footnote-dw, natbib=true, mincitenames=1, maxcitenames=2, backend=biber]{biblatex}
